...
#define PLUGIN "[ZB3EX] ZClass: Banshee"
#define VERSION "2.0"
#define AUTHOR "Dias"
...
new const zclass_clawsmodelorigin[] = "v_knife_witch2_zombi.mdl"
new const zombiegrenade_modelhost[] = "models/zombie_thehero/v_zombibomb_witch2_zombi_host.mdl"
new const zombiegrenade_modelorigin[] = "models/zombie_thehero/v_zombibomb_witch2_zombi.mdl"
...
public client_PreThink(id)
{
	...
	static target, body;
 	...
 	new Float: BatDistance = zb3_get_user_level(id) > 1 ? float(BAT_MAX_DISTANCE_ORIGIN) : float(BAT_MAX_DISTANCE_HOST)
 	if( Distance < BatDistance && CheckTarget ) 
 		cmd_drop(id)
}*/
public cmd_drop(id)
{
