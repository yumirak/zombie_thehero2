...
new const UnPrecache_ModelList[40][] =
{
...
public plugin_init() 
{
	...
	//server_print("PrecacheX: Model Unprecached: %i",  ArraySize(ArModel))
	//server_print("PrecacheX: Sound Unprecached: %i",  ArraySize(ArSound))
}
